...
#define  TT_SUPPORT_SUBPIXEL_HINTING_MINIMAL
   ...
   * version of FreeType has support for COLRv1 API. This definition is useful
   * to FreeType clients that want to build in support for COLRv1 depending on a
   * tip-of-tree checkout before it is officially released in FreeType and while
   * the feature cannot yet be tested against using version macros. Don't change
   * this macro. This may be removed once the feature is in a FreeType release
   * version and version macros can be used to test for availability.
   */
